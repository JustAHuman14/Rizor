...
using Rizor.ViewModels;
using TextMateSharp.Grammars;

namespace Rizor.Views;
...
public partial class MainWindow : Window
{
    ...
    private async Task SaveFileAsync(string title, string suggestedFileName)
    {
        // self explanatory ig
    ...
    private async Task SaveChangesAsync()
    {
        try
        {
            ...
            if (result == ButtonResult.Yes)
                await SaveFileAsync("Save File", "untitled");
        }
        catch (Exception)
        {
            ShowError();
    ...
    private async void OnSaveAs(object? sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            ClearStatusBar();
            _saveAs = true;
            await SaveFileAsync("Save File As", _fileOpened != null ? _fileOpened.Name : "untitled");
        }
        catch (Exception)
        {
            ShowError();
